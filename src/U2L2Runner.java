public class U2L2Runner {
   public static void main(String[] args) {
      Rectangle backyard1 = new Rectangle(150, 200);
      ...
      int backyard1Perimeter = ((backyard1.getLength() + backyard1.getWidth())*2);
      ...
      int perimeter = (backyard1Perimeter) + (backyard2Perimeter) + (backyard3Perimeter);
